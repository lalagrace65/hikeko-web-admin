...
export default function Coupons(){
    ...
    return(
        <Layout>
            <Link className={"bg-customPrBg rounded-md text-white py-1 px-2"} href={'/coupons/new'}>Add new coupon</Link>
                ...
                <tbody>
                    {coupons.map(coupon => (
                        <tr key={coupon._id}>
                            ...
                            <td></td>
                            <td>
                                <Link href={'/coupons/edit/'+coupon._id}>
                                ...
                                <Link href={'/coupons/delete/'+coupon._id}>
