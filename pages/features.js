...
export default function Features(){
    ...
    return(
        <Layout>
            <Link className={"bg-customPrBg rounded-md text-white py-1 px-2"} 
                href={'/feature/new'}>
                Add new feature
            </Link>
            <table className="basic mt-2">
                ...
                <tbody>
                    {features.map(feature => (
                        <tr key={feature._id}>
                            <td>{feature.titleText_1}</td>
                            <td>{feature.description_1}</td>
                            <td>{feature.bannerImage_1.map((link,index) =>(
                                <img key={index} src={link} alt=''
                                className="h-20 w-20 object-cover rounded-lg"
                                />
                                ))}
                            </td>
                            <td>{feature.titleText_2}</td>
                            <td>{feature.description_2}</td>
                            <td>{feature.bannerImage_2.map((link,index) =>(
                                <img key={index} src={link} alt=''
                                className="h-20 w-20 object-cover rounded-lg"
                                />
                                ))}
                            </td>
                            <td>{feature.titleText_3}</td>
                            <td>{feature.description_3}</td>
                            <td>{feature.bannerImage_3.map((link,index) =>(
                                <img key={index} src={link} alt=''
                                className="h-20 w-20 object-cover rounded-lg"
                                />
                                ))}
                            ...
                            <td></td>
                            <td>
                                <Link href={'/feature/edit/'+feature._id}>
                                ...
                                <Link href={'/feature/delete/'+feature._id}>
