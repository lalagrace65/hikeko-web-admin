            ...
            <table className="basic mt-2">
                ...
                <tbody>
                    {travelAgency.map(travelAgency => (
                        <tr key={travelAgency._id}>
                            <td>{travelAgency.travelAgencyName}</td>
                            <td>{travelAgency.email}</td>
                            <td>{travelAgency.password}</td>
                            <td>{travelAgency.location}</td>
                            <td>{travelAgency.businessPermit.map((link,index) =>(
                                <img key={index} src={link} alt=''
                                className="h-20 w-20 object-cover rounded-lg"
                                />
                                ))}
                            </td>
                            <td>{travelAgency.birCertificate.map((link,index) =>(
                                <img key={index} src={link} alt=''
                                className="h-20 w-20 object-cover rounded-lg"
                                />
                                ))}
                            </td>
                            <td>{travelAgency.dtiPermit.map((link,index) =>(
                                <img key={index} src={link} alt=''
                                className="h-20 w-20 object-cover rounded-lg"
                                />
                                ))}
                            </td>
                            <td>{travelAgency.mayorPermit.map((link,index) =>(
                                <img key={index} src={link} alt=''
                                className="h-20 w-20 object-cover rounded-lg"
                                />
                                ))}
                            ...
                            <td></td>
                            <td>
                                <Link href={'/travelAgency/edit/'+travelAgency._id}>
                                ...
                                <Link href={'/travelAgency/delete/'+travelAgency._id}>
